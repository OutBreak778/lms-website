      ...
      <div className="flex flex-col max-w-4xl mx-auto pb-20">
        <div className="p-4">
          <VideoPlayer
            ...
            playback={muxData?.playbackId!}
            isLocked={isLocked}
            complete={completeOnEnd}
          />
        </div>
        <div>
              ...
              <div className="p-4">
                {attachments.map((attachment) => (
                  <a 
                    ...
                    target="_blank"
                    key={attachment.id}
                    className="flex my-2 items-center p-3 w-full bg-sky-200 border text-sky-700 rounded-md hover:underline"
                  >
                    <File />
